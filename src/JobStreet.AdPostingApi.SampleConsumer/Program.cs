...
using Polly;
using Polly.Retry;
using JobStreet.AdPostingApi.Client;
using JobStreet.AdPostingApi.Client.Models;
using JobStreet.AdPostingApi.Client.Models.JobStreet;
using JobStreet.AdPostingApi.Client.Resources;
using Environment = JobStreet.AdPostingApi.Client.Environment;

namespace JobStreet.AdPostingApi.SampleConsumer
{
